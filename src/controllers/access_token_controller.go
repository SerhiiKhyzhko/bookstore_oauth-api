...
func NewHandler(service tokenservice.Service, timeout time.Duration) *AccessTokenHandler {
...
func (handler *AccessTokenHandler) RefreshToken(c *gin.Context) {
...
func (handler *AccessTokenHandler) VerifyToken(c *gin.Context) {
